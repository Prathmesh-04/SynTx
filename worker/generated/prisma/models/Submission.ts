...
export type SubmissionWhereInput = {
  ...
  input?: Prisma.StringNullableFilter<"Submission"> | string | null
...
export type SubmissionScalarWhereWithAggregatesInput = {
  ...
  input?: Prisma.StringNullableWithAggregatesFilter<"Submission"> | string | null
}
...
export type SubmissionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"language" | "userId" | "id" | "output" | "sourceCode" | "status" | "input", ExtArgs["result"]["submission"]>
...
export interface SubmissionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `language`
   * const submissionWithLanguageOnly = await prisma.submission.findMany({ select: { language: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Submissions and only return the `language`
   * const submissionWithLanguageOnly = await prisma.submission.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Submissions and only return the `language`
   * const submissionWithLanguageOnly = await prisma.submission.updateManyAndReturn({
   *   select: { language: true },
   *   where: {
   *     // ... provide filter here
   *   },
